...
const ArrowRight = ({onClick, onEnter, disabled}: PaginationArrowProps) => {
  return <PaginationArrow onClick={onClick} onEnter={onEnter} disabled={disabled} id={'related-arrow-right'} path={ARROW_RIGHT_PATH} />;
};

const ArrowLeft = ({onClick, onEnter, disabled}: PaginationArrowProps) => {
  return <PaginationArrow onClick={onClick} onEnter={onEnter} disabled={disabled} id={'related-arrow-left'} path={ARROW_LEFT_PATH} />;
};
